...
INSERT INTO `categories` (`id`, `category_type_id`, `category_name`, `description`, `status`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `products` (`id`, `product_code`, `base_name`, `description`, `quantity`, `base_price`, `discount_price`, `cgst`, `sgst`, `weight`, `stone_type_id`, `pearl_type_id`, `polish_type_id`, `category_id`, `is_active`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `tab_categories` (`id`, `name`, `slug`, `is_active`, `created_at`, `updated_at`) VALUES
...
(16, 'MORE AT ETTHNICOAST', 'more-at-etthnicoast', 1, '2026-02-26 20:30:37', '2026-02-26 20:30:37');
...
INSERT INTO `tab_sub_categories` (`id`, `category_id`, `name`, `slug`, `is_active`, `created_at`, `updated_at`) VALUES
...
(1, 'Anshuman Majumder', 'KH-0001', 'admin@example.com', 'Thu, Feb 19, 2026 1:33 AM', '2026-03-10 01:54:50', NULL, 'Active', 'User', NULL, NULL, NULL, NULL, NULL, NULL, '$2y$12$2XVWpOVNpW6nyQVCWWRPTORFx9o7A/fYNkfwOZWxY/0xuiv.1amsm', NULL, '2026-02-18 20:03:21', '2026-03-09 20:24:50'),
(2, 'Anshuman Majumder', 'ETHAE597HRW', 'user1@gmail.com', '2026-03-08', '2026-03-08 07:32:56', '9899889988', 'active', 'etthnicoast_user', NULL, NULL, NULL, NULL, NULL, NULL, '$2y$12$MvjXGCWIPlDBxRmUozwyzOwlmOJ/Xn4QOcIdvX00yRC3WLgAEaQUy', '05vIz3lMaTAbLaxGFSdkbKR8wmQxzZI2k4rdb4ODG8bN4sjZ73UGKPkg0ngd', '2026-03-08 01:19:18', '2026-03-08 02:02:56');
