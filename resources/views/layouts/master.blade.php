                        ...
                        {{-- <form action="#">
                            <div class="searchinputs">
                                ...
                                <div class="search-addon">
                                    <span><img src="{{ asset('public/assets/img/icons/closes.svg') }}" alt="img"></span>
                                </div>
                            </div>
...
{{-- 
                <li class="nav-item dropdown has-arrow flag-nav">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);" role="button">
                        <img src="{{ asset('public/assets/img/flags/us1.png') }}" alt="" height="20">
                    </a>
                ...
                <li class="nav-item dropdown">
                    {{-- <a href="javascript:void(0);" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <img src="{{ asset('public/assets/img/icons/notification-bing.svg') }}" alt="img">
                                        ...
                                        <div class="media d-flex">
                                            ...
                                            <div class="media-body flex-grow-1">
                                                <p class="noti-details">
                                                    <span class="noti-title">ADMIN</span> 
                                                    added new task 
                ...
                <li class="nav-item dropdown has-arrow main-drop">
                    <a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
                        <span class="user-img">
                            <img src="{{ asset('public/assets/img/profiles/avatar-17.jpg') }}" alt="">
                    ...
                    <div class="dropdown-menu menu-drop-user">
                        <div class="profilename">
                            <div class="profileset">
                                <span class="user-img"><img src="{{ asset('public/assets/img/profiles/avatar-17.jpg') }}" alt="">
                            ...
                            <a class="dropdown-item logout pb-0" href="{{ route('logout') }}">
                                <img src="{{ asset('public/assets/img/icons/log-out.svg') }}" class="me-2" alt="img">Logout
                            </a>
                        </div>
                    </div>
                </li>
